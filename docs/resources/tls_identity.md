...
description: |-
  Manages a tls_identity resource via the executor.
---
...
- `fullchain_sha256` (string) - SHA-256 checksum of the managed fullchain PEM.
...
- `private_key_sha256` (string) - SHA-256 checksum of the managed private key PEM.
