...
func ResourceSchema() pluginsdk.Schema {
	return pluginsdk.Schema{
		Attributes: map[string]pluginsdk.Attribute{
			...
			"config_path":      {Type: pluginsdk.AttrString, Computed: true, Description: "Backend-specific configuration file managed by tf-linux-provider."},
			"service_name":     {Type: pluginsdk.AttrString, Computed: true, Description: "Backend-specific service name managed by tf-linux-provider."},
		},
	}
}
